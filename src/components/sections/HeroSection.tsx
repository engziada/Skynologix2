  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-navy-dark">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute top-1/4 right-1/4 w-[500px] h-[500px] bg-accent/10 rounded-full blur-[120px] animate-float pointer-events-none" />
        <div className="absolute bottom-1/4 left-1/4 w-[300px] h-[300px] bg-accent/5 rounded-full blur-[100px] animate-float pointer-events-none" style={{ animationDelay: '-3s' }} />
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full">
        <div className={`w-full md:w-3/5 space-y-10 ${locale === "en" ? "me-auto" : "ms-auto"}`}>
          ...
          {/* CTA Buttons */}
          <Reveal delay={400} className="flex flex-row-reverse flex-wrap gap-6 pt-6">
            <Link
              href="/contact"
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-3 px-10 py-5 glass-card border border-accent/20 rounded-xl text-xl font-bold text-accent-light hover:bg-accent/10 transition-all hover:scale-[1.02] active:scale-[0.98]"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-20">
            ...
            ].map(({ icon: Icon, titleKey }, i) => (
              <Reveal key={titleKey} delay={600 + (i * 100)}>
                <div
                  className="glass-card p-8 rounded-2xl hover:bg-white/10 transition-all group cursor-default h-full"
                >
                  <div className="w-12 h-12 rounded-xl bg-accent/10 flex items-center justify-center mb-5 group-hover:bg-accent/20 group-hover:scale-110 transition-all duration-500">
